...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidFinishLaunching(application: UIApplication) {
        UITabBar.appearance().tintColor = UIColor(red:236/255, green:5/255,blue:156/255,alpha:1.0)
    }

    // MARK: - Core Data stack

    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "key-lime.Shopkins_List" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Shopkins_List", withExtension: "momd")!
